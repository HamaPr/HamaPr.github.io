...
***1. 가상 네트워크 구성도***
   ...
   ![가상 네트워크 구성도]({{ "/assets/images/owasp-top-10/A00_P1-1.png" | relative_url }})
...
*   ***Target (목표 서버):***
   ...
   ![Ubuntu 서버 IP 주소 확인]({{ "/assets/images/owasp-top-10/A00_P2-1.png" | relative_url }})
   
*   ***Attacker (공격자):***
    *   **OS:** Kali Linux
    *   **IP:** `192.9.200.12`
    *   **Services:** Burp Suite, Nmap, Nikto, Sqlmap 등
   ![Kali Linux IP 주소 확인]({{ "/assets/images/owasp-top-10/A00_P2-2.png" | relative_url }})
...
취약점 분석을 위해 **Damn Vulnerable Web Application `DVWA`**를 타겟 서버에 배포했으며 공격자 머신에는 웹 프록시의 핵심 도구인 `Burp Suite`를 비롯하여 `Nmap·Nikto·Sqlmap` 등 자동화 도구의 세팅을 완료하여 수동 분석과 자동화 분석을 병행할 준비를 마쳤습니다.
   ...
   ![DVWA 메인 페이지]({{ "/assets/images/owasp-top-10/A00_P3-1.png" | relative_url }})
   ![Burp Suite 패킷 캡처]({{ "/assets/images/owasp-top-10/A00_P4-1.png" | relative_url }})
