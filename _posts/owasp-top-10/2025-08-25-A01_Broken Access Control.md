...
*   ***공격 검증:***
   ...
   ![]({{ "/assets/images/owasp-top-10/A01_P1-1.png" | relative_url }})

   이 취약점의 근본 원인은 아래 소스코드와 같이 사용자 입력값`$_GET['page']`을 아무런 검증이나 필터링 없이 신뢰하고 파일 경로로 사용했기 때문입니다.

   ![]({{ "/assets/images/owasp-top-10/A01_P1-2.png" | relative_url }})
...
*   ***공격 검증:***
   ...
   ![]({{ "/assets/images/owasp-top-10/A03_P2-1.png" | relative_url }})
...
*   ***공격 검증:***
   ...
   ![]({{ "/assets/images/owasp-top-10/A01_P3-1.png" | relative_url }})
...
*   ***공격 검증:***
   ...
   ![자신의 정보를 요청하는 가상 API](/assets/images/owasp-top-10/A01_P4-1.png)
   ...
   ![다른 사용자의 정보를 요청하는 IDOR 공격](/assets/images/owasp-top-10/A01_P4-2.png)
...
#### ***취약한 코드 분석 Low Level***
   ...
   ![]({{ "/assets/images/owasp-top-10/A01_S-1.png" | relative_url }})
...
#### ***안전한 코드 분석 Impossible Level***
   ...
   ![]({{ "/assets/images/owasp-top-10/A01_S-2.png" | relative_url }})  
