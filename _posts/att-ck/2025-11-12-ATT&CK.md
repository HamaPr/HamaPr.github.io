...
- [1. 정찰 Reconnaissance {#tactic-1}](#1-정찰-reconnaissance-tactic-1)
  - [1.1. 포트 및 서비스 스캔 T1595](#11-포트-및-서비스-스캔-t1595)
  - [1.2. 자동화된 취약점 분석 T1592](#12-자동화된-취약점-분석-t1592)
- [2. 자원 개발 Resource Development {#tactic-2}](#2-자원-개발-resource-development-tactic-2)
- [3. 초기 접근 Initial Access {#tactic-3}](#3-초기-접근-initial-access-tactic-3)
  - [3.1. Windows Server (10.0.0.31) 공격 {#ia-win}](#31-windows-server-100031-공격-ia-win)
  ...
  - [3.2. Ubuntu Server (10.0.0.42) 공격 {#ia-ubu}](#32-ubuntu-server-100042-공격-ia-ubu)
...
- [4. 실행 Execution {#tactic-4}](#4-실행-execution-tactic-4)
- [5. 지속성 확보 Persistence {#tactic-5}](#5-지속성-확보-persistence-tactic-5)
...
- [6. 권한 상승 Privilege Escalation {#tactic-6}](#6-권한-상승-privilege-escalation-tactic-6)
- [7. 방어 회피 Defense Evasion {#tactic-7}](#7-방어-회피-defense-evasion-tactic-7)
- [8. 자격증명 탈취 Credential Access {#tactic-8}](#8-자격증명-탈취-credential-access-tactic-8)
...
- [9. 탐색 Discovery {#tactic-9}](#9-탐색-discovery-tactic-9)
  - [10. 횡적 이동 Lateral Movement {#tactic-10}](#10-횡적-이동-lateral-movement-tactic-10)
- [11. 정보 수집 Collection {#tactic-11}](#11-정보-수집-collection-tactic-11)
...
- [12. 명령 및 제어 Command \& Control {#tactic-12}](#12-명령-및-제어-command--control-tactic-12)
- [13. 정보 유출 Exfiltration {#tactic-13}](#13-정보-유출-exfiltration-tactic-13)
- [14. 영향 Impact {#tactic-14}](#14-영향-impact-tactic-14)
...
<div class="report-container">
  <a href="reports/nmap_w2k8.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.1.1.nmap_w2k8.png" alt="Nmap Report w2k8">
...
<div class="report-container">
  <a href="reports/nmap_ubuntu.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.1.2.nmap_ubuntu.png" alt="Nmap Report ubuntu">
      <figcaption>클릭 시 전체 결과 화면으로 이동합니다.</figcaption>
    </figure>
  </a>
</div>
...
<div class="report-container">
  <a href="reports/nesus_w2k8_adscan.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.2.1.nessus_w2k8.png" alt="Window Report1">
      <figcaption>클릭 시 전체 결과 화면으로 이동합니다.</figcaption>
    </figure>
  </a>
</div>
<div class="report-container">
  <a href="reports/gvm_w2k8_report.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.2.2.gvm_w2k8.png" alt="Window Report2">
      <figcaption>클릭 시 전체 결과 화면으로 이동합니다.</figcaption>
    </figure>
  </a>
</div>
...
<div class="report-container">
  <a href="reports/nesus_ubuntu_adscan.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.2.3.nessus_ubuntu.png" alt="Ubuntu Report">
      <figcaption>클릭 시 전체 결과 화면으로 이동합니다.</figcaption>
    </figure>
  </a>
</div>
<div class="report-container">
  <a href="reports/gvm_ubuntu_report.pdf" target="_blank">
    <figure class="report-thumb">
      <img src="assets/images/1.2.4.gvm_ubuntu.png" alt="Ubuntu Report2">
      <figcaption>클릭 시 전체 결과 화면으로 이동합니다.</figcaption>
    </figure>
  </a>
</div>
...
## 2. 자원 개발 Resource Development {#tactic-2}
...
## 3. 초기 접근 Initial Access {#tactic-3}
...
### 3.1. Windows Server (10.0.0.31) 공격 {#ia-win}
...
![wftp1](assets/images/3.1.1.1.ftp.png)
![wftp2](assets/images/3.1.1.2.ftp.png)
...
![wssh1](assets/images/3.1.2.1.ssh.png)
![wssh2](assets/images/3.1.2.2.ssh.png)
...
![wiis1](assets/images/3.1.3.1.iis.png)
![wiis2](assets/images/3.1.3.2.iis.png)
...
![wsmb1](assets/images/3.1.4.1.smb.png)
...
![wjava1](assets/images/3.1.5.1.java.png)
...
![wfish1](assets/images/3.1.6.1.fish.png)
![wfish2](assets/images/3.1.6.2.fish.png)
![wfish3](assets/images/3.1.6.3.fish.png)
...
![wman1](assets/images/3.1.7.1.manage.png)
...
![wtom1](assets/images/3.1.8.1.tomcat.png)
![wtom2](assets/images/3.1.8.2.tomcat2.png)
...
![wweb1](assets/images/3.1.9.1.webdav.png)
![wweb2](assets/images/3.1.9.2.webdav.png)
...
![wele1](assets/images/3.1.10.1.elesearch.png)

---

### 3.2. Ubuntu Server (10.0.0.42) 공격 {#ia-ubu}
...
![uftp1](assets/images/3.2.1.1.ftp.png)
...
![ussh1](assets/images/3.2.2.1.ssh.png)
![ussh2](assets/images/3.2.2.2.ssh.png)
...
![uhttp1](assets/images/3.2.3.1.http.png)
![uhttp2](assets/images/3.2.3.2.http.png)
...
![usmb1](assets/images/3.2.4.1.smb.png)
![usmb2](assets/images/3.2.4.2.smb.png)
...
![ucups1](assets/images/3.2.5.1.cups.png)
![ucups2](assets/images/3.2.5.2.cups.png)
...
![uirc](assets/images/3.2.6.1.irc.png)

* * *
{:.short-rule}

## 4. 실행 Execution {#tactic-4}
...
![wex1](assets/images/4.1.ex.png)
![wex2](assets/images/4.2.ex.png)

## 5. 지속성 확보 Persistence {#tactic-5}
...
![wper1](assets/images/5.1.1.wper.png)
![wper2](assets/images/5.1.2.wper.png)
...
![uper1](assets/images/5.2.1.uper.png)
![uper2](assets/images/5.2.2.uper.png)
![uper3](assets/images/5.2.3.uper.png)

## 6. 권한 상승 Privilege Escalation {#tactic-6}
...
![wpri1](assets/images/6.1.pri.png)
![wpri2](assets/images/6.2.pri.png)

## 7. 방어 회피 Defense Evasion {#tactic-7}
...
![wdef1](assets/images/7.1.def.png)
![wdef2](assets/images/7.2.def.png)

## 8. 자격증명 탈취 Credential Access {#tactic-8}
...
![wcre1](assets/images/8.1.1.cre.png)
![wcre2](assets/images/8.1.2.cre.png)
...
![ucre1](assets/images/8.1.3.cre.png)
...
![wmitm1](assets/images/8.2.1.mitm.png)
![wmitm2](assets/images/8.2.2.mitm.png)

## 9. 탐색 Discovery {#tactic-9}
...
![wdis1](assets/images/9.1.wdis.png)
![wdis2](assets/images/9.2.wdis.png)
![wdis3](assets/images/9.3.wdis.png)
![wdis4](assets/images/9.4.wdis.png)

### 10. 횡적 이동 Lateral Movement {#tactic-10}
...
![wlat1](assets/images/10.1.wlat.png)
![wlat2](assets/images/10.2.wlat.png)
![wlat3](assets/images/10.3.wlat.png)

## 11. 정보 수집 Collection {#tactic-11}
...
![wflag1](assets/images/11.1.1.1.wflag.png)
![wflag2](assets/images/11.1.1.2.wflag.png)
...
![wflag1](assets/images/11.1.2.1.wflag.png)
...
![wflag1](assets/images/11.1.3.1.wflag.png)
![wflag2](assets/images/11.1.3.2.wflag.png)
...
![wflag1](assets/images/11.1.4.1.wflag.png)
![wflag2](assets/images/11.1.4.2.wflag.png)
![wflag3](assets/images/11.1.4.3.wflag.png)
...
![wflag1](assets/images/11.1.5.1.wflag.png)
...
![wflag1](assets/images/11.1.6.1.wflag.png)
![wflag2](assets/images/11.1.6.2.wflag.png)
![wflag2](assets/images/11.1.6.3.wflag.png)
...
![wflag1](assets/images/11.1.7.1.wflag.png)
![wflag2](assets/images/11.1.7.2.wflag.png)
...
![wflag1](assets/images/11.1.8.1.wflag.png)
![wflag2](assets/images/11.1.8.2.wflag.png)
...
![wflag1](assets/images/11.1.9.1.wflag.png)
...
![wflag1](assets/images/11.1.10.1.wflag.png)
![wflag2](assets/images/11.1.10.2.wflag.png)
...
![wflag1](assets/images/11.1.11.1.wflag.png)
![wflag2](assets/images/11.1.11.2.wflag.png)
...
![uflag1](assets/images/11.2.1.1.uflag.png)
![uflag2](assets/images/11.2.1.2.uflag.png)
...
![uflag1](assets/images/11.2.2.1.uflag.png)
...
![uflag1](assets/images/11.2.3.1.uflag.png)
...
![uflag1](assets/images/11.2.4.1.uflag.png)
![uflag2](assets/images/11.2.4.2.uflag.png)

## 12. 명령 및 제어 Command & Control {#tactic-12}
...
![wcc1](assets/images/12.1.cc.png)
![wcc2](assets/images/12.2.cc.png)

## 13. 정보 유출 Exfiltration {#tactic-13}
...
![down1](assets/images/13.1.down.png)
![scp2](assets/images/13.2.scp.png)

## 14. 영향 Impact {#tactic-14}
...
![wdhcp1](assets/images/14.1.1.dhcp.png)
![wdhcp2](assets/images/14.1.2.dhcp.png)
...
![wlog1](assets/images/14.2.1.log.png)
![wlog2](assets/images/14.2.2.log.png)
