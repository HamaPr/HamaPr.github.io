...
```mermaid
flowchart LR
    classDef attacker fill:#2a0a0a,stroke:#ff5555,stroke-width:2px,color:#ffcece;
    classDef target fill:#0a1a0a,stroke:#55ff55,stroke-width:2px,color:#ceffce;
    classDef infra fill:#1a1a1a,stroke:#aaaaaa,stroke-width:2px,color:#ffffff;
    ...
    linkStyle 0 stroke:#ff5555,stroke-width:3px;
    linkStyle 1 stroke:#ff5555,stroke-width:2px;
    linkStyle 2 stroke:#aaaaaa,stroke-width:2px,stroke-dasharray: 5 5;
    linkStyle 3 stroke:#ffaa00,stroke-width:3px,color:#ffaa00;
    
    style Attacker_Zone fill:transparent,stroke:#ff5555,stroke-width:2px,stroke-dasharray: 5 5,color:#ff5555
    style Target_Zone fill:transparent,stroke:#55ff55,stroke-width:2px,stroke-dasharray: 5 5,color:#55ff55
```
...
```mermaid
flowchart LR
    classDef hacker fill:#330000,stroke:#ff0000,stroke-width:2px,color:#ffcccc;
    classDef azure fill:#002b4d,stroke:#0078D4,stroke-width:2px,color:#cceeff;
    classDef service fill:#004466,stroke:#00aaff,stroke-width:1px,stroke-dasharray: 2 2,color:#ffffff;
    classDef victim fill:#2b2000,stroke:#ffaa00,stroke-width:2px,color:#ffddaa;
    ...
    style Cloud_C2 fill:transparent,stroke:#0078D4,stroke-width:2px,stroke-dasharray: 5 5,color:#0078D4
    style Services fill:#001122,stroke:#005588,stroke-width:1px,color:#88ccff
    style Victim_Network fill:transparent,stroke:#ffaa00,stroke-width:2px,stroke-dasharray: 5 5,color:#ffaa00
    
    linkStyle 0 stroke:#ff5555,stroke-width:3px;
    linkStyle 1 stroke:#00aaff,stroke-width:2px;
    linkStyle 2 stroke:#00aaff,stroke-width:2px;
    linkStyle 3 stroke:#ffaa00,stroke-width:3px,color:#ffaa00;
```
