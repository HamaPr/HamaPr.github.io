...
Cisco CCNA Introduction to Networks(ITN) 과정을 이수하고, Course Final Exam과 Packet Tracer Skills Assessment(PTSA)를 모두 통과했다. 이 과정을 통해 네트워크 기본 구조와 프로토콜 동작, Cisco 장비 CLI 설정에 대해 학습했다.
